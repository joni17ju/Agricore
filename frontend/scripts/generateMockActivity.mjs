...
const staff = [
  ...
  },
  {
    ...
    sectionId: null,
    assignedSectionIds: ['sec_bsa3a', 'sec_bsa3b'],
    status: 'active',
    earnedBadges: [],
  },
  {
...
/**
 * Student profiles.
 * steps: missions passed in curriculum order (32 total incl. quizzes)
 * skill: typical score · activity: chance of studying on a given day
 * idle: days since last activity · extra: 'failNext' | 'suddenDrop'
 */
const students = [
  // BSA 3-A
  { id: 'juan', first: 'Juan', last: 'Dela Cruz', section: 'sec_bsa3a', steps: 16, skill: 84, activity: 0.55, idle: 0, streakDays: 5, extra: 'failNext' },
  { id: 'msantos', first: 'Maria', last: 'Santos', section: 'sec_bsa3a', steps: 21, skill: 93, activity: 0.7, idle: 0 },
  { id: 'rbautista', first: 'Rodolfo', last: 'Bautista', section: 'sec_bsa3a', steps: 19, skill: 88, activity: 0.6, idle: 1 },
  { id: 'areyes', first: 'Ana', last: 'Reyes', section: 'sec_bsa3a', steps: 15, skill: 82, activity: 0.5, idle: 2 },
  { id: 'bnavarro', first: 'Ben', last: 'Navarro', section: 'sec_bsa3a', steps: 14, skill: 86, activity: 0.5, idle: 0, extra: 'suddenDrop' },
  { id: 'asantos', first: 'Anya', last: 'Santos', section: 'sec_bsa3a', steps: 13, skill: 79, activity: 0.45, idle: 1 },
  { id: 'cmendoza', first: 'Carlo', last: 'Mendoza', section: 'sec_bsa3a', steps: 11, skill: 75, activity: 0.4, idle: 3 },
  { id: 'kramos', first: 'Kristine', last: 'Ramos', section: 'sec_bsa3a', steps: 12, skill: 85, activity: 0.4, idle: 2 },
  { id: 'mgarcia', first: 'Mark Anthony', last: 'Garcia', section: 'sec_bsa3a', steps: 8, skill: 68, activity: 0.35, idle: 4 },
  { id: 'jvillareal', first: 'Jessa', last: 'Villareal', section: 'sec_bsa3a', steps: 6, skill: 62, activity: 0.3, idle: 12 },
  { id: 'pcastillo', first: 'Paolo', last: 'Castillo', section: 'sec_bsa3a', steps: 10, skill: 73, activity: 0.4, idle: 2 },
  { id: 'rdomingo', first: 'Rhea', last: 'Domingo', section: 'sec_bsa3a', steps: 3, skill: 52, activity: 0.25, idle: 9, extra: 'failNext' },
  // BSA 3-B
  { id: 'mbautista', first: 'Maria', last: 'Bautista', section: 'sec_bsa3b', steps: 18, skill: 90, activity: 0.6, idle: 0 },
  { id: 'jflores', first: 'Joshua', last: 'Flores', section: 'sec_bsa3b', steps: 15, skill: 83, activity: 0.5, idle: 1 },
  { id: 'atorres', first: 'Angelica', last: 'Torres', section: 'sec_bsa3b', steps: 17, skill: 87, activity: 0.55, idle: 0 },
  { id: 'raquino', first: 'Renz', last: 'Aquino', section: 'sec_bsa3b', steps: 9, skill: 70, activity: 0.35, idle: 3 },
  { id: 'pcabrera', first: 'Princess', last: 'Cabrera', section: 'sec_bsa3b', steps: 12, skill: 80, activity: 0.45, idle: 1, extra: 'suddenDrop' },
  { id: 'ksalazar', first: 'Kevin', last: 'Salazar', section: 'sec_bsa3b', steps: 7, skill: 66, activity: 0.3, idle: 5 },
  { id: 'mgonzales', first: 'Mae Ann', last: 'Gonzales', section: 'sec_bsa3b', steps: 13, skill: 81, activity: 0.45, idle: 2 },
  { id: 'jpascual', first: 'Jerome', last: 'Pascual', section: 'sec_bsa3b', steps: 4, skill: 57, activity: 0.25, idle: 10, extra: 'failNext' },
  { id: 'cmorales', first: 'Clarisse', last: 'Morales', section: 'sec_bsa3b', steps: 11, skill: 77, activity: 0.4, idle: 2 },
  { id: 'vrivera', first: 'Vince', last: 'Rivera', section: 'sec_bsa3b', steps: 2, skill: 60, activity: 0.2, idle: 25, status: 'inactive' },
  // BSA 3-C
  { id: 'dlopez', first: 'Daniel', last: 'Lopez', section: 'sec_bsa3c', steps: 14, skill: 84, activity: 0.5, idle: 1 },
  { id: 'hmercado', first: 'Hazel', last: 'Mercado', section: 'sec_bsa3c', steps: 16, skill: 89, activity: 0.55, idle: 0 },
  { id: 'atan', first: 'Arnel', last: 'Tan', section: 'sec_bsa3c', steps: 10, skill: 74, activity: 0.4, idle: 2 },
  { id: 'lsoriano', first: 'Lorraine', last: 'Soriano', section: 'sec_bsa3c', steps: 12, skill: 82, activity: 0.45, idle: 1 },
  { id: 'jignacio', first: 'Jomar', last: 'Ignacio', section: 'sec_bsa3c', steps: 5, skill: 58, activity: 0.3, idle: 8 },
  { id: 'tvaldez', first: 'Trisha', last: 'Valdez', section: 'sec_bsa3c', steps: 9, skill: 76, activity: 0.35, idle: 3 },
  { id: 'nfernandez', first: 'Nikko', last: 'Fernandez', section: 'sec_bsa3c', steps: 11, skill: 72, activity: 0.4, idle: 2, extra: 'suddenDrop' },
  { id: 'smanalo', first: 'Shaira', last: 'Manalo', section: 'sec_bsa3c', steps: 0, skill: 70, activity: 0, idle: null },
];
...
const orderedSteps = sortModules(modules).flatMap((module) => {
  ...
  const levels = moduleLessons.flatMap((lesson) => getLessonGameMissions(missions, lesson._id));
  const quiz = getModuleQuiz(missions, moduleLessons);
  return quiz ? [...levels, quiz] : levels;
});
...
function snapScore(mission, raw) {
  ...
  const allowed = isQuiz(mission) ? ALLOWED_SCORES.quiz : ALLOWED_SCORES[gameTypeOf(mission)];
...
function timeSpent(mission, passed) {
  if (isQuiz(mission)) return intBetween(150, 420);
...
for (const [index, profile] of students.entries()) {
  ...
  for (let step = 0; step < profile.steps; step += 1) {
    ...
    const difficulty = isQuiz(mission) ? 0 : DIFFICULTY[gameTypeOf(mission)] + (LESSON_DIFFICULTY[mission.lessonId] ?? 0);
